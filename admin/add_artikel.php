...
<body class="bg-white dark:bg-gray-900 text-gray-900 dark:text-white min-h-screen font-sans transition-colors duration-500">
    ...
    <!-- Header -->
    <header class="bg-gray-100 dark:bg-gray-800 text-teal-600 dark:text-teal-400 py-6 shadow flex justify-between items-center px-6">
    ...
    <div class="max-w-7xl mx-auto mt-10 px-4 grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <aside class="bg-gray-100 dark:bg-gray-800 rounded-xl shadow p-6">
            ...
            <ul class="space-y-3 text-gray-700 dark:text-gray-300">
                ...
                <li><a href="data_artikel.php" class="block text-teal-600 dark:text-teal-400 font-bold">Kelola Artikel</a></li>
        ...
        <main class="lg:col-span-3 bg-gray-100 dark:bg-gray-800 rounded-xl shadow p-6">
            <form action="proses_add_artikel.php" method="post" class="space-y-6">
                <!-- Judul Artikel -->
                <div>
                    <label for="nama_artikel" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Judul Artikel</label>
                    <input type="text" id="nama_artikel" name="nama_artikel" required
                        class="w-full p-3 rounded-md border border-gray-400 dark:border-gray-600 bg-white dark:bg-gray-900 text-gray-900 dark:text-white focus:ring-teal-500 focus:border-teal-500">
                </div>

                <!-- Kategori Artikel -->
                <div>
                    <label for="kategori" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Kategori Artikel</label>
                ...
                <!-- Isi Artikel -->
                <div>
                    <label for="isi_artikel" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Isi Artikel</label>
